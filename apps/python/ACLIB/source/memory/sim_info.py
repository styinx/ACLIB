...
class AC_PROP:
    ...
    InstantDrift = 19
    IsDriftInvalid = 20
    IsEngineLimiterOn = 21
    LapCount = 22
    LapInvalidated = 23
    LapTime = 24
    LastFF = 25
    LastLap = 26
    LocalAngularVelocity = 27
    LocalVelocity = 28
    Mz = 29
    NdSlip = 30
    NormalizedSplinePosition = 31
    PerformanceMeter = 32
    SlipAngle = 33
    SlipAngleContactPatch = 34
    SlipRatio = 35
    SpeedTotal = 36
    Steer = 37
    SuspensionTravel = 38
    TurboBoost = 39
    TyreDirtyLevel = 40
    TyreContactNormal = 41
    TyreContactPoint = 42
    TyreHeadingVector = 43
    TyreLoadedRadius = 44
    TyreRadius = 45
    TyreRightVector = 46
    TyreSlip = 47
    ...
    TyreVelocity = 49
    Velocity = 50
    WheelAngularSpeed = 51
    WorldPosition = 52
    Caster = 53
    CurrentTyresCoreTemp = 54
    LastTyresTemp = 55
    DynamicPressure = 56
    RideHeight = 57
    ToeInDeg = 58
