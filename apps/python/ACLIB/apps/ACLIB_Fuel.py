...
class Fuel(ACApp):
    ...
    def __init__(self, data: ACData = None, meta: ACMeta = None):
        super().__init__('ACLIB_Fuel', 200, 200, 300, 78)
        ...
        self._normal_font.size = px2pt(self.size[1] / 3)
        ...
        self._fuel_bar = ACLIBProgressBar(self._grid, 0, 0, self._data.car.max_fuel)
        ...
        self._avg_km = ACLabel(self._grid, '', 'center', self._small_font)
        ...
        self._avg_lap = ACLabel(self._grid, '', 'center', self._small_font)
